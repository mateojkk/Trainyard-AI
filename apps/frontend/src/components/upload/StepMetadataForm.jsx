  ...
  return (
    <div className="bg-[#111111] border border-[#1a1a1a] rounded-lg overflow-hidden space-y-6">
      ...
      <div className="p-6 pt-0 space-y-5">
        {loadingAi ? (
          <div className="flex items-center gap-3 bg-brand-blue/5 border border-brand-blue/20 p-4 rounded text-xs text-gray-300">
        ...
        <div className="space-y-4 text-xs">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full bg-[#141414] border border-[#2e2e2e] focus:border-brand-blue rounded p-2.5 text-gray-200 placeholder-gray-600 focus:outline-none transition duration-150"
            />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full bg-[#141414] border border-[#2e2e2e] focus:border-brand-blue rounded p-2.5 text-gray-200 placeholder-gray-600 focus:outline-none transition duration-150 font-sans"
            />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-1.5">
              ...
              <select
                ...
                className="w-full bg-[#141414] border border-[#2e2e2e] focus:border-brand-blue rounded p-2.5 text-gray-200 focus:outline-none transition duration-150 cursor-pointer"
              >
            ...
            <div className="space-y-1.5">
              <label className="text-gray-400 block font-semibold">Price (USDC)</label>
              <input
                type="number"
                min="0.01"
                step="0.01"
                ...
                className="w-full bg-[#141414] border border-[#2e2e2e] focus:border-brand-blue rounded p-2.5 text-gray-200 placeholder-gray-600 focus:outline-none transition duration-150 font-mono"
              />
            </div>
          </div>
        ...
        <div className="flex gap-4 pt-2">
          ...
          <button
            ...
            className="w-2/3 py-2.5 bg-brand-blue hover:bg-blue-400 disabled:bg-gray-800 text-black disabled:text-gray-500 font-bold rounded text-xs uppercase tracking-wider transition cursor-pointer flex items-center justify-center gap-1.5"
          >
        ...
        {!account && (
          <div className="text-[10px] text-center text-blue-300 bg-blue-950/10 border border-brand-blue/10 p-2.5 rounded leading-normal">
